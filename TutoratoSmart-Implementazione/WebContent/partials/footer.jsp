...
<body>
	<footer id="footer" style="margin-top:25px; width: 100%; background-color:#232F3E;">
		<div class="row text-center">
		    ...
		    <div style="float: left;width: 33%;color:white;padding-top: 4%;">
		    	<h5 class="font-weight-bold mb-4" style="">2019 Copyright: <a href="<%=request.getContextPath() %>/View/index.jsp"> TutoratoSmart.com</a></h5>
			</div>
		  	  
		    <div style="float: left;width: 33%;color:white; padding-top: 1%;">
